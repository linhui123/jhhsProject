...
public class LesseeViewHolder extends AbsRecyclerViewHolder<LesseeBean.WBankLeaseItemsBean> {
    ...
    protected void onBindView(final LesseeBean.WBankLeaseItemsBean item) {
        if (item != null) {
            ...
            mBinding.etName.setText(item.getName() != null ? item.getName() : "");
            mBinding.etXinghao.setText(item.getFixP17() != null ? item.getFixP17() : "");
            mBinding.tvBrand.setText(item.getBrandName() != null ? item.getBrandName() : "");
            mBinding.etNo.setText(item.getMachineNum() != null ? item.getMachineNum() : "");
            mBinding.etPrice.setText(item.getMachinePrice() != null ? item.getMachinePrice() : "");
            mBinding.tvBrand.setText(item.getBrandName() != null ? item.getBrandName() : "");
            mBinding.etM1.setText(item.getM1() != null ? item.getM1() : "");
            mBinding.etM2.setText(item.getM2() != null ? item.getM2() : "");
            mBinding.etM3.setText(item.getM3() != null ? item.getM3() : "");
            mBinding.etM4.setText(item.getM4() != null ? item.getM4() : "");
            mBinding.tvM5.setText(item.getM5() != null ? item.getM5() : "");
            mBinding.etM6.setText(item.getM6() != null ? item.getM6() : "");
