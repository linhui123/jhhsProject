...
public class CreateOrderFragment extends AbsFragment<FragmentCreateOrderBinding> {
    ...
    protected void setupViews() {
        ...
        LinearLayout.LayoutParams llParams = (LinearLayout.LayoutParams) mDataBinding.rlLocation.getLayoutParams();
        llParams.topMargin += DisplayUtils.getStatusBarHeight(getContext());
        mDataBinding.rlLocation.setLayoutParams(llParams);
        ...
        double yufei = 10.00;//运费
        double youhui = 10.00;//优惠
        ...
        mDataBinding.tvSum.setText("￥" + total);
