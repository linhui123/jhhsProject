...
public class UploadImgAction extends AHttpService<BaseEntity<UploadImageResponse>> {

    private File uploadImageFile;

    public static UploadImgAction newInstance(Context context, File file) {
        return new UploadImgAction(context, file);
    }

    public UploadImgAction(Context context, File file) {
        super(context);
