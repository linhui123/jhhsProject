...
public class AdvancedPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private OnTabStripItemListener mTabItemListener;
    // @formatter:on
    ...
    public AdvancedPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        textAlignLeft = a.getBoolean(R.styleable.AdvancedPagerSlidingTabStrip_apTabTextAlignLeft, textAlignLeft);
...
//                addIconTab(i, R.drawable.home_categry_icon_n, pager.getAdapter().getPageTitle(i).toString());
    ...
    private void addTextTab(final int position, String title) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (position == currentPosition) {
                    if (mTabItemListener != null) mTabItemListener.onTabRepeatClick(position);
                    return;
                }
        ...
        txt.setGravity(textAlignLeft ? Gravity.LEFT : Gravity.CENTER);
        txt.setSingleLine();
        ...
        if (textAlignLeft) {
            ...
            txtParams.setMargins(DisplayUtils.dip2px(getContext(), 14), 0, 0, 0);
        } else {
...
//        txtParams.addRule(RelativeLayout.CENTER_IN_PARENT);
        ...
        layoutParams.addRule(RelativeLayout.RIGHT_OF, R.id.id_tab_txt);
        layoutParams.setMargins(getResources().getDimensionPixelSize(R.dimen.psts_dot_m_left), getResources().getDimensionPixelSize(R.dimen.psts_dot_m_top), getResources().getDimensionPixelSize(R.dimen.psts_dot_m_right), 0);
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mTabItemListener != null)
                    mTabItemListener.onTabSelectClick(position, currentPosition);
            }
        });
...
//        txtParams.addRule(RelativeLayout.CENTER_IN_PARENT);
    ...
    public void setTabItemListener(OnTabStripItemListener listener) {
        this.mTabItemListener = listener;
    }

    public TextView getTxt(int position) {
    ...
    public void showDot(int index, String dotTxt) {
        String dotNum = Integer.parseInt(dotTxt) >= 100 ? "99+" : dotTxt;
        RelativeLayout tab = (RelativeLayout) tabsContainer.getChildAt(index);
        dot_layout = (TextView) tab.getChildAt(tab.getChildCount() - 1);
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) dot_layout.getLayoutParams();
        layoutParams.width = RelativeLayout.LayoutParams.WRAP_CONTENT;
        layoutParams.height = RelativeLayout.LayoutParams.WRAP_CONTENT;
        dot_layout.setText(dotNum);
        dot_layout.setVisibility(View.VISIBLE);
    }
    ...
    public int getDotTxt() {
        try {
            return Integer.parseInt(dot_layout.getText().toString().trim());
        } catch (Exception e) {
            return 1;
        }
    }
...
//        canvas.drawRect(0, height - underlineHeight, tabsContainer.getWidth(), height, rectPaint);
    ...
    private void drawTabTextMode(Canvas canvas) {
        ...
        //绘制提示下划线
        canvas.drawRect(lineLeft + currentTextViewLeft + 40, height - indicatorHeight, lineLeft + currentTextViewRight - 40, height, rectPaint);
//        canvas.drawRect(lineLeft , height - indicatorHeight, currentTextViewRight , height, rectPaint);
        // 分割线paint
    ...
    public void setSelectItem(int position) {
        for (int i = 0; i < tabsContainer.getChildCount(); i++) {
            ...
            if (i == position) {
                ...
                ((TextView) linearLayout.getChildAt(0)).setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
                if (pager.getAdapter() instanceof IconTabProvider) {
...
//                    ((TextView) linearLayout.getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.home_categry_icon_f_n, 0, 0);
                ...
                ((TextView) linearLayout.getChildAt(0)).setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
                if (pager.getAdapter() instanceof IconTabProvider) {
...
//                    ((TextView) linearLayout.getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.home_categry_icon_n, 0, 0);
    ...
    public void setTextAlignLeft(boolean textAlignLeft) {
