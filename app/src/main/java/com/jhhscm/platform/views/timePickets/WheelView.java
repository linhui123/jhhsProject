...
public class WheelView extends View {
	...
	/** 当前值与标签文本颜色 */
	private static final int VALUE_TEXT_COLOR = 0xFF1890FF;
	...
	private void initResourcesIfNecessary() {
		...
		if (labelPaint == null) {
			...
			labelPaint.setTextSize(textSize(15));
		}
