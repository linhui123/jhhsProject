...
//    public void display(String path, int orientation, ImageView imageView, int width, int height) {
//        if (imageView == null) {
//            return;
//        }
//        mWidth = width;
...
//    }
    ...
    private void addBitmapToMemoryCache(String key, Bitmap bmp) {
        if (!TextUtils.isEmpty(key) && bmp != null) {
            int degree = FileUtils.getBitmapDegree(key);
            Bitmap bitmap = FileUtils.rotateBitmap(bmp, degree);
    ...
    public class BitmapLoadTask extends AsyncTask<Integer, Object, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer... params) {
            Bitmap bitmap = tryLoadFromDiskCache(path);
    ...
    private boolean cacheBitmap2Disk(Bitmap bitmap, OutputStream outputStream) throws IllegalStateException {
        if (bitmap != null) {
