...
// * 类说明：
// */
//public class PatientsImagePhotoPickerActivity extends AbsToolbarActivity {
//    /**
//     * 图片选择模式，int类型
//     */
...
//        Intent intent = new Intent(context, PatientsImagePhotoPickerActivity.class);
...
//            ((PatientsImagePhotoPickerActivity) getActivity()).setToolBarRightText(text,true);
...
//            }else {
//                PatientsImageUploadingActivity.start(getContext(),mSelectList,mCaseBaseId,mTimeNodeId);
