 ...
 * 类说明：
 */
public class PhotoPickerActivity extends AbsToolbarActivity {
    /**
     * 图片选择模式，int类型
     */
     ...
     */
    public static void startActivity(Context context, int code, ArrayList<String> images, int selectMaxCount) {
    ...
    public static void startActivity(Context context, int code, ArrayList<String> images, int selectMaxCount, boolean withCarmer) {
        Intent intent = new Intent(context, PhotoPickerActivity.class);
        intent.putExtra(EXTRA_SELECT_MODE, MODE_MULTI);
...
//                closeProgressDialog();
        ...
        private void refreshActionStatus() {
            ...
            ((PhotoPickerActivity) getActivity()).setToolBarRightText(text, true);
