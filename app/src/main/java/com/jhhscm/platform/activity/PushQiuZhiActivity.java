...
import com.jhhscm.platform.fragment.my.labour.PushQiuZhiFragment;

public class PushQiuZhiActivity extends AbsToolbarActivity {
    private int type;//0只读；1编辑

    public static void start(Context context, String labour_code, String id, int type) {
        Intent intent = new Intent(context, PushQiuZhiActivity.class);
    ...
    protected AbsFragment onCreateContentView() {
        return PushQiuZhiFragment.instance();
    }
